...
DEFAULT_BOOK_SOURCES = [
    ...
    BookSourceRecord(
        ...
        description="可匿名搜索并导入起点作品、公开目录和章节，也可同步当前登录账号书架。",
        bookKind="长小说",
        language="中文",
    ...
    BookSourceRecord(
        ...
        description="通过书旗网页内核搜索并导入夸克小说作品、目录和匿名免费章节。",
        bookKind="长小说",
        language="中文",
    ...
    BookSourceRecord(
        ...
        description="可搜索并导入公开作品、分组目录和漫画页面。",
        bookKind="漫画",
        language="中文",
    ...
    BookSourceRecord(
        ...
        description="仅搜索和预览公开作品元数据；登录或付费下载资源不接入。",
        bookKind="漫画",
        language="中文",
